...
import 'package:sabak_18_bmi_calculator_male_female_page/features/domain/show_result.dart';
import 'package:sabak_18_bmi_calculator_male_female_page/features/presentation/components/colculator_container.dart';
import 'package:sabak_18_bmi_calculator_male_female_page/features/presentation/components/height_card.dart';
import 'package:sabak_18_bmi_calculator_male_female_page/features/presentation/components/male_female_card.dart';
import 'package:sabak_18_bmi_calculator_male_female_page/features/presentation/components/weight_age_card.dart';
import 'package:sabak_18_bmi_calculator_male_female_page/features/presentation/constants/app_colors.dart';
import 'package:sabak_18_bmi_calculator_male_female_page/features/presentation/constants/app_sized_box.dart';
      ...
      bottomNavigationBar: CalcualtorContainer(
        onTap: () {
          ...
          if (bmiResult < 17.5) {
            ...
            print('Сиз арыксыз');
          } else if (bmiResult > 17.5 && bmiResult <= 23) {
